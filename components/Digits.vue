<template>
  <div class="digits">
    <p class="digits__entry fonts__small">
      <span class="digits__prefix">E</span> <a class="digits__contact" :href="'mailto:' + contactInfo.email">{{contactInfo.email}}</a>
    </p>
    <p class="digits__entry fonts__small">
    ...
    <p class="digits__entry fonts__small" v-show="hasSocialLinks">
      ...
      <a class="digits__contact digits__contact--dark-link digits__social-link" v-show="contactInfo.behance" :href="contactInfo.behance" target="_blank"><i class="fab fa-behance"></i></a>
      <a class="digits__contact digits__contact--dark-link digits__social-link" v-show="contactInfo.resume" :href="contactInfo.resume" target="_blank"><i class="far fa-file"></i></a>
    </p>
  </div>
</template>
